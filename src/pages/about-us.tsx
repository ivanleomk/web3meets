...
const people = [
  ...
  //   twitterUrl: "https://twitter.com/yokurang",
  //   linkedinUrl: "https://www.linkedin.com/in/alnmathw/",
  // },
  {
    name: "Jones",
    role: "Business Lead",
    imageUrl: "/jones.jpeg",
    bio: "Data Analytics @ NUS",
    twitterUrl: "https://twitter.com/ivanleomk",
    linkedinUrl: "https://www.linkedin.com/in/ivanleo/",
  },
];
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="text-md mt-6 leading-8 text-gray-600">
            We&apos;re a small team collating all the fun Crypto events in
            Singapore and Hong Kong - subscribe to our Telegram channel or use
            our website, which ever works for you.
          </p>
        </div>
        <ul
          role="list"
